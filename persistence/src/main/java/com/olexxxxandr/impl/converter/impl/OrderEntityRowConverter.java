...
import com.olexxxxandr.entity.impl.OrderEntity.PaymentType;
        ...
        try {
            ...
            ClientEntity clientEntity =
                    DaoFactory.getInstance()
                            .getClientDao()
                            .findOneById(
                                    UUID.fromString(resultSet.getString("client_id")), connection)
                            .orElseThrow(
                                    () ->
            ...
            String message =
                    "Не вдалось отримати ResultSet в %s. Детально: %s"
                            .formatted(
                                    OrderEntityRowConverter.class.getSimpleName(), e.getMessage());
