...
public class SpareEntity extends BaseEntity<UUID> implements Entity {
    ...
    // не хороший варіант
    private String extraFieldQuantity;

    private SpareEntity(
            UUID id, WorkroomEntity workroomEntity, String name, Money price, int quantityInStock) {
        super(id);
    ...
    public String getExtraFieldQuantity() {
        return extraFieldQuantity;
    }

    public void setExtraFieldQuantity(String extraFieldQuantity) {
